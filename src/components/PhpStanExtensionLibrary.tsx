...
import { EXTENSIONS_LIBRARY } from '../data/phpstanExtensionsLibrary';
      ...
      <div className="space-y-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          {filteredExtensions.map((ext) => {
            ...
            // Some extensions also get recommendation-aware coverage in the Rules Beyond Core advisor further down.
            const linkedCommunityPackage = COMMUNITY_RULE_PACKAGES.find((pkg) => pkg.linkedExtensionId === ext.id);
                ...
                <div className="space-y-2.5">
                  <div className="flex items-start justify-between">
                    <div>
                      ...
                      {linkedCommunityPackage && (
                        <span className="flex items-center gap-1 text-[9px] text-indigo-600 mt-0.5">
                          <Layers className="w-3 h-3" />
                          Same toggle as &quot;{linkedCommunityPackage.displayName}&quot; in Rules Beyond Core below
                        </span>
                      )}
                    </div>
